...
def popularity():
    ...
    rows = execute_query("""SELECT DISTINCT(movie_id), title, popularity, language.language_name
                        FROM movie JOIN movie_languages using (movie_id) JOIN language using (language_id)
